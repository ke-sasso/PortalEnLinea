...
<form id="infoGeneral" method="post"  action="{{route('store.mandamiento.pagoshigienicos')}}">
<div class="panel panel-success">
<div class="panel-heading">
    <h3 class="panel-title">Pago Inscripciones Higiénicos</h3>
</div>
                ...
                <div id="paso5">
                        ...
                        <table class="table table-th-block table-primary table-hover" id="tr-pagos">
                            <thead class="the-box dark full">
                                <tr>
                                    <th colspan ="2">@if(count($p1)>0 && count($p2)>0)<input type="radio"  name="idPago" id="idPago" value="1" onclick="suma({{$p1->VALOR}},{{$p2->VALOR}});">@endif &nbsp;&nbsp; Registro o Reconocimiento Nacional de Higiénicos</th>
                                </tr>
                            </thead>
                            <tbody>
                     ...
                     <div class="table-responsive the-box  no-border">
                        <table class="table table-th-block table-primary table-hover" id="tr-pagos">
                            <thead class="the-box dark full">
                                <tr>
                                    <th colspan ="2">@if(count($p1)>0 && count($p3)>0)<input type="radio"  name="idPago" id="idPago" value="2" onclick="suma({{$p1->VALOR}},{{$p3->VALOR}});">@endif &nbsp;&nbsp; Registro o Reconocimiento Extranjero de Higiénicos</th>
                                </tr>
                            </thead>
                            <tbody>
