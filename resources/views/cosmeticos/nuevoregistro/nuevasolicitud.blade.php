...
@section('contenido')
    ...
    <form  id="CosPreForm" role="form"  method="post" enctype="multipart/form-data">
        ...
        <div class="panel panel-success">
            ...
            <div class="panel-body">
                <div id="smartwizard">
                    ...
                    <div>
                        <div id="step-1" class="">
                            @include('cosmeticos.nuevoregistro.pasos.paso1.mandamiento')
                            <input type="hidden" name="img_val[1]" id="img_val1" value="" />
                        </div>
                        <div id="step-2" class="">
                            @include('cosmeticos.nuevoregistro.pasos.paso2.gnralProducto')
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            if (performance.navigation.type == 1) {
                ...
                window.location = '{{route("get.cospreregistro.nuevasolicitud")}}';
            }
            ...
            $("#smartwizard").on("showStep", function(e, anchorObject, stepNumber, stepDirection) {
                ...
                if(step==3){   console.log('idSol2:'+ $('#idSolicitud2').val()); }
                if(step==4){ $('#idSolicitud3').val($('#idSolicitud2').val()); config.flags[0].loadimp=true; }
                if(step==5){ $('#idSolicitud4').val($('#idSolicitud3').val()); config.flags[0].loadidst=true; }
                if(step==6){ $('#idSolicitud5').val($('#idSolicitud4').val()); dataStep6(); }
            });


            $("#smartwizard").on("leaveStep", function(e, anchorObject, stepNumber, stepDirection) {
                console.log("ESTOY EN EL PASO"+ stepNumber);
                ...
                if(stepDirection === 'forward' && elmForm)
                {
                    ...
                    if(stepNumber+1==1){
                        if(config.flags[0].mandvalidado==false) {
                            alertify.alert("Mensaje de sistema","El mandamiento no ha sido validado!");
                            return false;
                        }
                        else if(!$('input[type=radio][name=tipoTramite]:checked').val()){
                            alertify.alert("Mensaje de sistema","Debe seleccionar el tipo de trámite!");
                            return false;
                        }
                        else {
                            return true;
                     ...
                     if(stepNumber+1==4){
                        ...
                        else if (tipoTra==3 || tipoTra==5 || config.flags[0].origen=='E36'){
                     ...
                     if(stepNumber+1==5){
                        console.log('ESTOY EN EL PASO 5');
