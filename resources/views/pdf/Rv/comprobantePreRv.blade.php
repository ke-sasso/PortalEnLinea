...
<div align="center">
    <div>
        <h3><b>CONSTANCIA DE PRESENTACIÓN</b><br>UNIDAD DE REGISTRO Y VISADO DE MEDICAMENTOS Y DISPOSITIVOS MÉDICOS</h3>
        ...
        <table class="comprobante">
            ...
            <tr>
                ...
                <td>{{$info->fechaRecepcion}}</td>
                <td><b>Fecha de presentación:</b></td>
                <td>{{$info->fechaEnvio}}</td>
            </tr>
            <tr>
                <td><b>Anualidad:</b></td>
                <td></td>
    ...
    <div>
        ...
        <p align="center"><b>Nota:</b> Se ha recibido solicitud para revisión de requisitos.</p>
    </div>
</div>
<footer id="footer">
    <hr>
