...
<div class="panel panel-success">
    <div class="panel-heading" >
        <h3 class="panel-title">
            ...
            B&uacute;squeda Avanzada de Tramites Registro
...
<div class="panel panel-success"> 
  ...
  <div class="panel-heading">
    <h3 class="panel-title">TRÁMITES REGISTRO</h3>
  </div>
  <div class="panel-body">  
...
$( document ).ready(function() {
    ...
    var table = $('#dt-tramitesrv').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: "{{ route('dt.data.solicitudes.c') }}",
            data: function (d) {
        ...
        columns: [
            ...
            {data: 'solicitante', name: 'solicitante',orderable:false},
            ...
            {data: 'archivos', name: 'archivos',searchable:false,orderable:false}
