...
function armarPresentacion(){
    ...
    if(emp2==0 && emp3==0){
        if(empaque1!='' && material1!='')
            texto= empaque1  +  ' DE ' + material + ' ' + color + ' X ' + por1 + ' '  + material1 + ' '+ accesorios;
    }
    else if(emp2==1 && emp3==0){
        texto= empaque2 + ' X '+ por2 + ' ' + empaque1  +  ' DE ' + material + ' ' + color + ' X ' + por1 + ' '  + material1 + ' '+ accesorios;
    }
    else if (emp2==1 && emp3==1){
        texto= empaque3 + ' X '+ por3 + ' ' + empaque2 + ' X ' + por2 + ' ' + empaque1  +  ' DE ' + material + ' ' + color + ' X ' + por1 + ' '  + material1 + ' '+ accesorios;
    }
    ...
    $('#certificadobpm').val(paisprinfab);
     ...
     $('#dt-fabricantesAlternos tbody tr').each(function(){
      ...
      $('#dt-fabricantesAcondicionador tbody tr').each(function(){
         ...
         $('#dt-pract-labacondicionador tbody').append('<tr><input form="RegistroPreStep6" type="hidden" name="practLabAcondi[]" value="'+valueinput+'"><td>'+$(celdas[0]).html()+'</td><td><input type="hidden" class="form-control" name="emisorAcondicionador-'+valueinput+'" value="'+noemi+'" form="RegistroPreStep6" />'+noemi+'</td><td><input form="RegistroPreStep6" type="date" class="form-control datepicker" id="fechaEmision-'+valueinput+'"  name="fechaEmision-'+valueinput+'" placeholder="dd-mm-yy" value="'+valueEmision+'"></td><td><input form="RegistroPreStep6" type="date" class="form-control datepicker" id="fechaVencimiento-'+valueinput+'"  name="fechaVencimiento-'+valueinput+'" placeholder="dd-mm-yyyy" value="'+valueVencimiento+'"></td><tr>');
                    ...
                    var id=$('#idSolicitud9').val();
                      ...
                      $.each($('input[type=file]'), function () {
                              ...
                              $('#' + $(this).attr('id')).fileinput({
                                ...
                                uploadUrl: "{{route('registropresolicitud.store.step10')}}",
