                  ...
                  <div class="row">
                      <div class="col-sm-12 col-md-8">
                          <div class="input-group ">
                            ...
                            <input type="text" class="form-control" id="propietarioProd" name="propietarioProd" value="" autocomplete="off" readonly required>
                          </div>
                      </div>
                      <div class="col-sm-4 col-md-4">
                          <div class="input-group">
                            <div class="input-group-addon" for="paisProp"><b>País:</b></div>
                            <input type="text" class="form-control" id="paisTitular" name="paisTitular" value="" autocomplete="off" readonly>
                          </div>
                      </div>
                  </div>
              </div>
                  ...
                  <div class="row">
                      <div class="col-sm-12 col-md-8">
                          <div class="input-group ">
                            ...
                            <input type="text" class="form-control" id="labFabricante" name="labFabricante" value="" autocomplete="off" readonly >
                          </div>
                      </div>
                      <div class="col-sm-4 col-md-4">
                          <div class="input-group">
                            <div class="input-group-addon" for="paisProp"><b>País Fabricante:</b></div>
                            <input type="text" class="form-control" id="paisFabri" name="paisFabri" value="" autocomplete="off" readonly>
                          </div>
                      </div>
                  </div>
              </div>
                  ...
                  <div class="row">
                      <div class="col-sm-12 col-md-12">
                          <div class="input-group ">
                            ...
                            <select name="listLabAcondicionador" id="listLabAcondicionador"  class="form-control" form="RegistroPreStep8"></select>
                          </div>
                      </div>
