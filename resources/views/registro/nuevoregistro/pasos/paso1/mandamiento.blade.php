                ...
                <div class="row">
                    <div class="col-sm-12 col-md-5">
                        <div class="input-group ">
                            ...
                            <input type="number" class="form-control" id="mandamiento" name="mandamiento" value="" autocomplete="off" required form="RegistroStep1y2">
                        </div>
                        <div class="help-block with-errors"></div>
                    </div>
                    <div class="col-sm-12 col-md-2">
                        <div class="input-group ">
                            <button type="button" class="btn btn-primary" id="paso1Guardar" name="paso1Guardar">Validar  <i class="fa fa fa-check" aria-hidden="true"></i></button>
                        </div>
                    </div>
