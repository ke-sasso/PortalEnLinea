	...
	<div id="panel-collapse-1">
		<div class="tab-content">
			<div class="tab-pane fade in active" id="farmacologia">
				<textarea form="RegistroPreStep9" class="form-control farmaco" id="farm" name="farm" placeholder="Digite la farmacología general..."></textarea>
			</div>
			<div class="tab-pane fade" id="mecanismo">
				<textarea form="RegistroPreStep9" class="form-control farmaco" id="mecaaccion" name="mecaaccion" placeholder="Digite los mecanismos de acción..."></textarea>
			</div>
			<div class="tab-pane fade" id="indicaciones">
				<textarea form="RegistroPreStep9" class="form-control farmaco" id="indicacion" name="indicacion" placeholder="Digite las indicaciones..."></textarea>
			</div>
			<div class="tab-pane fade" id="contradiciones">
				<textarea form="RegistroPreStep9" class="form-control farmaco" id="contrad" name="contrad" placeholder="Digite las contradiciones..."></textarea>
			</div>
			<div class="tab-pane fade" id="dosis">
				<textarea form="RegistroPreStep9" class="form-control farmaco" id="dos" name="dos" placeholder="Digite la dosis..."></textarea>
			</div>
			<div class="tab-pane fade" id="efectosas">
				<textarea form="RegistroPreStep9" class="form-control farmaco" id="efectos" name="efectos" placeholder="Digite los efectos secundarios o adversos..."></textarea>
			</div>
			<div class="tab-pane fade" id="advertencias">
				<textarea form="RegistroPreStep9" class="form-control farmaco" id="adv" name="adv" placeholder="Digite las advertencias..."></textarea>
			</div>
			<div class="tab-pane fade" id="interacciones">
				<textarea form="RegistroPreStep9" class="form-control farmaco" id="interaccion" name="interaccion" placeholder="Digite las principales interacciones..."></textarea>
			</div>
