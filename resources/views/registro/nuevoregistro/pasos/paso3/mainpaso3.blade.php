...
<div id="form-step-2" role="form" data-toggle="validator">
			...
			@include('registro.nuevoregistro.pasos.paso3.titular')
			@include('registro.nuevoregistro.pasos.paso3.represetantelegal')
			@include('registro.nuevoregistro.pasos.paso3.apoderado')
			@include('registro.nuevoregistro.pasos.paso3.profesional')
			@include('registro.nuevoregistro.pasos.paso3.interesado')
</div>
