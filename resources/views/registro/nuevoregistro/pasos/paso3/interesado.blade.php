                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="input-group">
                                     <label class="radio-inline">
                                        <input type="radio" name="oirNotificaciones" id="oirNotificaciones" value="1"  form="RegistroPreStep3" /> Correo electrónico
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" name="oirNotificaciones"  id="oirNotificaciones" value="2" form="RegistroPreStep3" /> Instalaciones de la DNM
                                    </label>
                                </div>
                </div>
        </div>
...
<div class="container-fluid the-box">
    ...
    <div id="datosTercerasPer" style="display: none;">
        <div class="form-group row">
                    ...
                    <div class="row">
                       <div class="col-sm-12 col-md-12">
                            <div class="input-group ">
                                ...
                                <textarea class="form-control" id="nominteresado" name="nominteresado" value=""  rows="2" form="RegistroPreStep3" autocomplete="off"></textarea>
                            </div>
                        </div>
                    </div>
            </div>
        ...
        <span class="label label-info">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <div class="input-group">
                            ...
                            <input type="email" class="form-control" name="correointeresado" id="correointeresado" value=""  form="RegistroPreStep3" autocomplete="off">
                        </div>
                    </div>
                </div>
                <div class="form-group row">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="direccioninteresado" id="direccioninteresado" value=""  form="RegistroPreStep3" autocomplete="off">
                        </div>
                    </div>
                </div>
                 <div class="form-group row">
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control phone_masking" name="tel1interesado" id="tel1interesado" value=""  form="RegistroPreStep3" autocomplete="off">
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                        <div class="input-group">
                            <div class="input-group-addon"><b>Teléfono 2:</b></div>
                            <input type="text" class="form-control phone_masking" name="tel2interesado" id="tel2interesado" value=""  form="RegistroPreStep3" autocomplete="off">
                        </div>
                    </div>
                </div>
    </div>
