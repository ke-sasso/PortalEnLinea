...
<input type="hidden" value="{!! $profesional->ID_PROFESIONAL !!}" name="idProfesional" form="RegistroPreStep3">
<div class="form-group row">
    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
        <div class="input-group">
            <div class="input-group-addon"><b>NIT:</b></div>
            <input type="text" class="form-control" name="nitProfesional" id="nitProfesional" value="{!! $profesional->NIT !!}" readonly form="RegistroPreStep3">
        </div>
    </div>
    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
        <div class="input-group">
