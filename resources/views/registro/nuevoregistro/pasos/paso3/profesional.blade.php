		...
		<div class="form-group row">											
			<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6"> 
				<div class="input-group">
				 ...
				 <input type="text" class="form-control" id="poderProf" placeholder="Digite el número de poder" name="poderProf" value="" autocomplete="off" required form="RegistroPreStep3">
