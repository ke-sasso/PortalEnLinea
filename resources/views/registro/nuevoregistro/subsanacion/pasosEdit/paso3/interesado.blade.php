                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="input-group">
                                     ...
                                     <label class="radio-inline">
                                        <input type="radio" name="oirNotificaciones" id="oirNotificaciones" value="1" @if($solicitud->solicitudesDetalle->idOirNotificaciones==1) checked @endif  form="RegistroPreStep3" disabled /> Correo electrónico
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" name="oirNotificaciones"  id="oirNotificaciones" value="2" @if($solicitud->solicitudesDetalle->idOirNotificaciones==2) checked @endif form="RegistroPreStep3" disabled /> Instalaciones de la DNM
                                    </label>
                                </div>
                </div>
        </div>
...
<div class="container-fluid the-box">
        ...
        <div class="form-group form-inline">
            ...
            @if($solicitud->solicitudesDetalle->tercerInteresado!=null || $solicitud->solicitudesDetalle->tercerInteresado!='')
                        <br>
             <label class="radio-inline">
                     <input type="radio" name="valTerceraPersona" id="valTerceraPersona" value="1" @if($solicitud->solicitudesDetalle->tercerInteresado==1) checked @endif disabled   form="RegistroPreStep3"> SI
                    </label>
                    <label class="radio-inline">
                        <input type="radio" name="valTerceraPersona" id="valTerceraPersona" value="0" @if($solicitud->solicitudesDetalle->tercerInteresado==0) checked @endif disabled  form="RegistroPreStep3">  NO ES DE MI CONOCIMIENTO
                    </label>
            @else
                    <br>
                     <label class="radio-inline">
                                <input type="radio" name="valTerceraPersona" id="valTerceraPersona" value="1" required form="RegistroPreStep3" disabled> SI
                    </label>
                    <label class="radio-inline">
                                <input type="radio" name="valTerceraPersona" id="valTerceraPersona" value="0" required form="RegistroPreStep3" disabled>  NO ES DE MI CONOCIMIENTO
                    </label>
            @endif
        </div>
